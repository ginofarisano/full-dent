...
/**
* Interfaccia grafica per l'inserimento di un nuovo fornitore.
* @author Filomena Fruncillo
*/
public class FormAggiungiFornitore2 extends javax.swing.JFrame {

   /**
    * Crea un nuovo Form. 
    */
   public FormAggiungiFornitore2() {
       initComponents();
   }
